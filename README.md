...
<!-- ===================== BADGES DE ESTATÍSTICAS DO REPOSITÓRIO =====================
...
Explique aqui, em 2-3 parágrafos:
- Qual problema o projeto resolve;
- Por que ele existe / qual a motivação;
- O que o diferencia de outras soluções (se aplicável).

## 🎬 Demonstração

<!-- Print, GIF ou link para vídeo/deploy do projeto -->
<p align="center">
  <img src=".github/assets/demo.gif" alt="Demonstração do projeto" width="700"/>
</p>

🔗 **Deploy:** [link-do-projeto-no-ar.com](#)

## ✨ Funcionalidades

- [x] Funcionalidade já implementada
- [x] Outra funcionalidade pronta
...
- (o que mais for necessário: Docker, banco de dados local, etc.)
...
| `PORT`         | Porta em que a aplicação sobe     | `3000`                  |
| `JWT_SECRET`   | Chave usada para assinar tokens   | `sua-chave-secreta`     |
...
Veja as [issues abertas](https://github.com/USUARIO/REPOSITORIO/issues) para a lista completa de propostas e bugs conhecidos.
